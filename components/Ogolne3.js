				...
				<Col lg={5} className="mx-auto my-2 ">
					<Card className="border-0 bg-transparent ">
						<Card.Body>
							...
							<Card.Text>
								{" "}
								Bij ons krijg je meer dan alleen een standaard service. We
								bieden betrokkenheid die jouw huis tot een levensproject maakt
								voor ons. Onze betrouwbaarheid en precisie vormen de basis voor
								elk project dat we uitvoeren.
							</Card.Text>
							<Card.Text>
							...
							<Card.Text>
								Vertrouw op ons om samen ruimtes te creëren die het verhaal van
								jouw dromen vertellen en volledig aan jouw verwachtingen
								voldoen.
							</Card.Text>
							<Card.Text></Card.Text>
						</Card.Body>
